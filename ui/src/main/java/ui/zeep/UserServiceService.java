 ...
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/userService?wsdl")
public class UserServiceService
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://services/", "UserServiceService");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://services/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "UserServicePort"), UserService.class, features);
    }
